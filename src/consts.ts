...
export const BLOG_URL = `https://${BLOG_TITLE}`
// export const BLOG_URL = 'http://localhost:8787'
export const PAGE_SIZE = 4
export const API_URL = 'https://dev.to/api'
export const DESCRIPTION = 'This is my developer blog and sandbox for playing with edge workers. I mostly write about web and JavaScript, sometimes Rust.'